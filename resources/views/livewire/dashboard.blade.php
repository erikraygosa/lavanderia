<div x-data="{ mostrarTotales: localStorage.getItem('dashMostrarTotales') === 'true' }">
    @php
    ...
    <div class="mb-6 flex items-center justify-between gap-4 flex-wrap">
        ...
        <div class="flex items-center gap-2 flex-wrap">
            {{-- Botón Mostrar/Ocultar totales --}}
            <button @click="mostrarTotales = !mostrarTotales; localStorage.setItem('dashMostrarTotales', mostrarTotales)"
                ...
                <span x-text="mostrarTotales ? 'Ocultar' : 'Mostrar'"></span>
            </button>
    ...
    {{-- KPIs de ventas (ocultos por defecto, se revelan con el botón Mostrar) --}}
    <div x-show="mostrarTotales" x-transition class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
        <div class="card">
